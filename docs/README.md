...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-14 22:12:19 UTC<br>状态：成功</p>
</section>
...
<p>今日精选2篇AI论文，精读1篇、速读1篇，聚焦虚假短视频识别与GraphRAG查询优化。最值得看的是满分精读《Detecting and Explaining Fake News Short Videos with Multimodal Content and Real-World Evidence》，用多模态内容结合真实世界证据检测并解释假新闻短视频。普通读者可先读这篇了解识别思路，速读的MOSAIC则适合关注GraphRAG检索策略的读者。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Detecting and Explaining Fake News Short Videos with Multimodal Content and Real-World Evidence">Detecting and Explaining Fake News Short Videos with Multimodal Content and Real-World Evidence</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="MOSAIC: Query-Aware Exploration Policy Adaptation for GraphRAG">MOSAIC: Query-Aware Exploration Policy Adaptation for GraphRAG</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">mfnd <strong>1</strong></span></div>
</section>
</div>
