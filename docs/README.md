...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-13 21:25:45 UTC<br>状态：成功</p>
</section>
...
<p>今日速读两篇均分 6.0 的论文，聚焦可信图智能体 RAG 与孟加拉语文化隐喻图像理解。最值得关注的是图智能体 RAG 的失败传播与“构造即保证”思路，以及孟加拉语多模态可解释数据集的构建。普通读者可优先了解 RAG 可靠性设计与低资源语言多模态解释这两条线索。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Building Trustworthy Graph-Agentic RAG for Social Good: Architectures, Failure Propagation, and Assurance by Construction">Building Trustworthy Graph-Agentic RAG for Social Good: Architectures, Failure Propagation, and Assurance by Construction</span></li><li><span class="dpr-home-dashboard-paper-title" title="BanglaMemeX: Advancing Cultural Metaphoric Image Interpretation in Bangla with a Multimodal Explainable Dataset">BanglaMemeX: Advancing Cultural Metaphoric Image Interpretation in Bangla with a Multimodal Explainable Dataset</span></li></ul>
  </div>
